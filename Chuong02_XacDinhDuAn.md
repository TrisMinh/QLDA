...
| G1: Xây dựng hệ thống giám sát môi trường nhà kính tự động | O1.2: Hiển thị dữ liệu trên Web Dashboard |
| G1: Xây dựng hệ thống giám sát môi trường nhà kính tự động | O1.3: Cảnh báo khi thông số vượt ngưỡng |
| G2: Xây dựng mô hình AI dự đoán và điều khiển tối ưu | O2.1: Huấn luyện mô hình ARX(5,1,2) dự đoán độ ẩm đất |
| G2: Xây dựng mô hình AI dự đoán và điều khiển tối ưu | O2.2: Tích hợp Kalman Filter lọc nhiễu cảm biến |
| G2: Xây dựng mô hình AI dự đoán và điều khiển tối ưu | O2.3: Triển khai MPC giữ độ ẩm đất trong vùng mục tiêu |
| G3: Đảm bảo truyền thông ổn định giữa các thành phần | O3.1: Giao tiếp WebSocket hai chiều ESP32 ↔ Backend |
| G3: Đảm bảo truyền thông ổn định giữa các thành phần | O3.2: Cơ chế ACK xác nhận lệnh điều khiển |
| G4: Hoàn thành dự án đúng tiến độ và chất lượng | O4.1: Hoàn thành trong 15 tuần |
| G4: Hoàn thành dự án đúng tiến độ và chất lượng | O4.2: Viết báo cáo đầy đủ và bảo vệ thành công |
