...
|  2  | Đinh Công Trung Sỹ | 23T_DT1 | **Firmware & Hardware** kiêm **Web & Backend Developer** | Thiết kế và lắp ráp phần cứng; lập trình ESP32; kết nối cảm biến nhiệt độ, độ ẩm, ánh sáng, độ ẩm đất; điều khiển relay; xây dựng WebSocket client/server; phát triển Django Backend & ReactJS Dashboard Full-stack; thiết kế REST API & MySQL Database |
